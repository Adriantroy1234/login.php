...
$query = "SELECT modelo, marca, precio FROM celulares WHERE precio = (SELECT MIN(precio) FROM celulares)";
...
if ($resultado->num_rows > 0) {
  ...
  $html .= "Celular más barato: " . $fila["marca"] . " " . $fila["modelo"] . " - $" . $fila["precio"];
} else {
